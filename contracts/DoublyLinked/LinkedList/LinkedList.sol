...
contract LinkedList is ILinkedList, CheapLinkedList, LinkedListUtility {
    ...
    function _remove(bytes32 element) internal override {
        super._remove(element);
        // update the number of element
        --numberOfElement;
    }

    function getListAsArray(uint256 page, uint256 pageSize) public view override returns (bytes32[] memory) {
